	...
	//@ts-ignore
	import figure from '../assets/figure.glb'
	...
	// console.log(test, '312')
 	export class WebGLScene {
		...
		this.mouse = new THREE.Vector2()
			...
			this.camera = new THREE.PerspectiveCamera(25, this.width / this.height, 1, 120)
	...
	addFire() {
		...
		this.gr.add(mesh2)
		this.gr.position.z = -60
		this.gr.position.y = -24
		this.gr.position.x = -6
		this.gr.rotation.y = 1
		this.gr.rotation.x = .3

		this.gr.scale.set(15,15,15)
	...
	async addObjects() {
		...
		const model = await this.gltf.loadAsync(figure)
		...
		this.instanced.position.z = -45
		this.instanced.position.x = -10
